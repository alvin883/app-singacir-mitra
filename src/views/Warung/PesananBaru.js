...
const PesananBaru = () => {
  ...
  const onAccept = () => {
    ...
    navigationServices.Navigate("dashboard/warung")
  }

  const onReject = () => {
    console.log("Pesanan Baru ditolak")
    navigationServices.Navigate("dashboard/warung/pesanan-tolak")
  }
        ...
        {data.map((val, i) => (
          <React.Fragment key={i}>
            <OrderItem
              ...
              time={val.date_order}
              onClickDetail={() => {
                navigationServices.Navigate("dashboard/warung/pesanan-detail", {
                  data: val,
                  withAction: true,
                  onAccept: onAccept,
                  onReject: onReject,
