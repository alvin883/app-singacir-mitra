...
const StepAddress = ({ data: defaultVal, onValidSubmit }) => {
  ...
  const handleMapClick = () => {
    navigationServices.Navigate("warung/setup/set-pin-map", {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <Input
        ...
        style={styles.input}
        label="Kelurahan"
        placeholder="Masukkan kelurahan warung ..."
      />
      ...
      <Input
        ...
        style={styles.input}
        label="Kecamatan"
        placeholder="Masukkan kecamatan warung ..."
      />
      ...
      <Input
        ...
        style={styles.input}
        label="Kode Pos"
        placeholder="Masukkan kode pos warung ..."
      />
