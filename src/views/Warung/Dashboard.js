  ...
  return (
    <View style={styles.wrapper}>
      <DashboardButton
        ...
        text="Profil Warung"
        onPress={() => navigationServices.Navigate("warung/dashboard/profil")}
      />
      <DashboardButton
        iconName={IconName.account}
        text="Data Pribadi"
        onPress={() => navigationServices.Navigate("warung/dashboard/pemilik")}
      />
      <DashboardButton
        iconName={IconName.mapMarker}
        text="Alamat"
        onPress={() => navigationServices.Navigate("warung/dashboard/alamat")}
      />
      <DashboardButton
        iconName={IconName.calendar}
        text="Jam Operasional"
        onPress={() => navigationServices.Navigate("warung/dashboard/jadwal")}
      />
      <DashboardButton
      ...
      <DashboardButton
        ...
        text="Cairkan Saldo"
        onPress={() => {
          navigationServices.Navigate("warung/dashboard/withdraw")
        }}
      />
      <DashboardButton
        iconName={IconName.menu}
        text="Atur Promo"
        onPress={() => {
          navigationServices.Navigate("warung/dashboard/promo")
        }}
      />
      ...
      <Button
        ...
        iconPosition="right"
        onPress={() => navigationServices.Navigate("warung/dashboard/preview")}
      />
    </View>
  )
}
