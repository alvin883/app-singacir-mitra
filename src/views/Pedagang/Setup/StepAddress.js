...
const StepAddress = ({ data: defaultVal, onValidSubmit }) => {
  ...
  const handleMapClick = () => {
    navigationServices.Navigate("pedagang/setup/set-pin-map", {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <Input
        ...
        label="Alamat"
        placeholder="Alamat lengkap pedagang ..."
      />
      ...
      <Input
        ...
        style={styles.input}
        label="Kelurahan"
        placeholder="Masukkan kelurahan pedagang ..."
      />
      ...
      <Input
        ...
        style={styles.input}
        label="Kecamatan"
        placeholder="Masukkan kecamatan pedagang ..."
      />
      ...
      <Input
        ...
        style={styles.input}
        label="Kode Pos"
        placeholder="Masukkan kode pos pedagang ..."
      />
        ...
        <View style={styles.mapWrapperActive}>
          ...
          >
            <Marker coordinate={pinMapCoordinate} style={styles.mapMarker}>
              <View>
                <Icon
                  name={IconName.mapMarkerPedagang}
