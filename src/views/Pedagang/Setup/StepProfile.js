...
const StepProfile = ({ onValidSubmit, data: defaultVal, isFirstSetup }) => {
  ...
  return (
    <View style={styles.wrapper}>
      {isFirstSetup && (
        <Heading style={styles.heading} text="Profil Dagangan" />
      )}
      ...
      <Input
        ...
        label="Nama Dagangan"
        placeholder="Masukkan nama dagangan anda ..."
      />
      ...
      <Input
        ...
        placeholder="Kategori dagangan anda ..."
      />
