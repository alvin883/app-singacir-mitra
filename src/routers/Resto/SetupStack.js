...
import { Resto, PinMap, EditSchedule, Success } from "_views"
...
const SetupStack = () => {
  ...
  return (
    <Stack.Navigator {...StackOptions}>
      <Stack.Screen
        name="resto/setup/steps"
        component={Resto.Setup.Steps}
        options={{ title: "Restoku" }}
      />
      <Stack.Screen
        name="resto/setup/set-pin-map"
        component={PinMap}
        options={{ title: "Pin Maps" }}
      />
      <Stack.Screen
        name="resto/setup/edit-jadwal"
        component={EditSchedule}
        options={{ title: "Jadwal" }}
      />
      <Stack.Screen
        name="resto/setup/success"
        component={Success}
        options={{ title: "Restoku" }}
        initialParams={{
